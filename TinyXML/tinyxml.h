...
// NOTE: henrikd 2005-10-07 - Trying to remove unnecessary linker flags
#if defined(_MSC_VER)
  #ifndef TINYXML_BUILD_LIBRARY
    #ifdef _DEBUG
      #pragma message("Note: including lib: tinyxmlD.lib\n")
      #pragma comment(lib, "tinyxmlD.lib")
    #else
      #pragma message("Note: including lib: tinyxml.lib\n")
      #pragma comment(lib, "tinyxml.lib")
    #endif//_DEBUG
  #endif//TINYXML_BUILD_LIBRARY
#endif//_MSC_VER

...
namespace DSC {
    ...
    public:
        ...
        static void tetralize(const std::vector<real>& points_interface, const std::vector<int>& faces_interface, std::vector<real>& points, std::vector<int>& tets, std::vector<int>& tet_labels)
        {
            DSC::vec3 size(4.);
